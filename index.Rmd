...
pamm(ped_status ~
  ...
  engine = 'bam',
  # use mgcv::bam() for faster fitting
...
On average, _Eurasian_ lakes froze 17 days later and thawed 3 days earlier in 2010 than 1950

On average, _North American_ lakes froze 25 days later and thawed 10 days earlier in 2010 than 1950
...
* Time-to-event models are a statistically appropriate way to model lake ice phenology data
